...
public class AddActivity_TimeSheet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_timesheet_addactivity);
        ...
        imageBackToTimesheetViewActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentBackToTimesheetViewActivity = new Intent(AddActivity_TimeSheet.this, ViewActivity_Timesheet.class);
